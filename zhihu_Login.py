...
def login(username, password, oncaptcha, sessiona, headers):
    ...
    captcha_content = sessiona.get('https://www.zhihu.com/captcha.png?r=%d&type=login' % (time.time() * 1000),
...
if __name__ == "__main__":
    ...
    login('xxxxx@qq.com', 'yourpassword', get_captcha, sessiona, headers)
